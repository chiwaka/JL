<?php
	...
	$row=Usuarios::getByIdPlus($id2,$id,$discoteca,$fechafiesta);
	$nombre=$row["Nombre"];
	$frase=$row["Frase"];
	$fechanacimiento=$row["FechaNacimiento"];
	$horoscopo=$row["horoscopo"];
	$parami=$row["ParaMi"];
	$parati=$row["ParaTi"];
	$esfavorito=$row["esfavorito"];
	$datos=array("nombre"=>$nombre,"frase"=>$frase,"fechanacimiento"=>$fechanacimiento,"horoscopo"=>$horoscopo,"parati"=>$parati,"parami"=>$parami,"esfavorito"=>$esfavorito);
